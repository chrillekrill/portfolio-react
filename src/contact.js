...
class Contact extends Component {
  ...
  render() {
    ...
    <textarea className="input-field mb-2" type="text" ref="msg" placeholder="Ask Me Anything..." value={this.state.message} onChange={this.handleChangeComment}/>
